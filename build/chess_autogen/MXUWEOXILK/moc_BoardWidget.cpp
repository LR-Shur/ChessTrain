...
void BoardWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (BoardWidget::*)(int )>(_a, &BoardWidget::gameOver, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (BoardWidget::*)(int )>(_a, &BoardWidget::piecePlaced, 1))
            return;
    }
}
...
// SIGNAL 1
void BoardWidget::piecePlaced(int _t1)
{
